...
<div class="container py-4">
  ...
  <form action="proses_pesan.php" method="POST">
    ...
    <div class="col-sm-6">
  <h1>Tentang Kami</h1>
  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi molestias modi dolores possimus repudiandae officia dignissimos delectus soluta vitae, quos optio minus accusamus tempore dolorum explicabo debitis sequi deleniti quisquam.</p>
    </div>
    </div>
  </div>
<!-- akhir bagian kontak -->
